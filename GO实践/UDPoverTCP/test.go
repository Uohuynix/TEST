...
func main() {
	flagListen := flag.String("listen", ":5000", "host:port of UDP address to listen on, use :port for all interfaces")
	flagBackend := flag.String("backend", "example.com:8080", "host:port of remote tcp connection")
	flagTimeout := flag.Int("timeout", 10, "tcp connection timeout")
